...
export default function AboutYourself2() {
        ...
        <View style={styles.card}>
          ...
          <View style={styles.contentContainer}>
            <View style={styles.contentContainer2}>
              <TextInputCustom placeholder="I am..." />
              <TextInputCustom placeholder="I like..." />
              <TextInputCustom placeholder="I appreciate when my date..." />
              <TextInputCustom placeholder="Height" />
            </View>
            <View style={styles.contentContainer3}>
              <CustomButton
                title="Continue"
                customClick={() => navigation.navigate('AboutYourself3')}
              />
            </View>
          </View>
        </View>
