...
export default function AboutYourself3() {
        ...
        <View style={styles.card}>
          ...
          <View style={styles.contentContainer}>
            <View style={styles.contentContainer2}>
              ...
              <TextInputCustom placeholder="Date of Birth" />
              <TextInputCustom placeholder="Location" />
            </View>
            <View style={styles.contentContainer3}>
              <CustomButton
                title="Continue"
                customClick={() => navigation.navigate('AboutYourself4')}
              />
            </View>
          </View>
        </View>
